                                 ...
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="starttime" name="starttime" type="text" autocomplete="off" required/>
                                   </div>
                                  </div>
                                 </div>
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <div class="input-group clockpicker"  data-align="top" data-autoclose="true">
                                    ...
                                    <input class="form-control" id="endtime" name="endtime" type="text" autocomplete="off" required/>
                                   </div>
                                  </div>
                                 </div>
                                 <div class="form-group form-group-lg">
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($doctorschedule=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$doctorschedule['scheduleId']."' class='delete'><i class='fa fa-trash' aria-hidden='true'></i></a>
                            </td>";
