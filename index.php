        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/doctor.png" height="40px"></a>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        <h4>Fill all the info carefully.</h4>
                                        <div class="row">
                                        ...
                                        <input type="text" name="icPatient" value="" class="form-control input-lg" placeholder="Your Username"  required/>
